...
public class MiniJLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"SEMICOLON", "COMMA", "ASSIGN", "INCREMENT", "DECREMENT", "PLUS", "MINUS", 
			"TIMES", "DIV", "MOD", "DOT", "EQUAL", "UNEQUAL", "LESSER", "GREATER", 
			"LESSER_EQ", "GREATER_EQ", "NOT", "AND", "OR", "RECORD", "REF", "IF", 
			"ELSE", "WHILE", "RETURN", "VOID", "INT", "BOOLEAN", "STRING", "TRUE", 
			"FALSE", "INTEGER", "STRINGCONSTANT", "ID", "LINE_COMMENT", "BLOCKCOMMENT", 
			"WS"
		};
	}
