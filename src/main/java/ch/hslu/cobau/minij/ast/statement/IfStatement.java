...
public class IfStatement extends Block {
    ...
    public void visitOnlyStatements(AstVisitor astVisitor) {

        super.visitChildren(astVisitor);
    }
    public void visitChildrenWithoutExpression(AstVisitor astVisitor) {
    ...
    public void visitChildrenWithoutElse(AstVisitor astVisitor) {
